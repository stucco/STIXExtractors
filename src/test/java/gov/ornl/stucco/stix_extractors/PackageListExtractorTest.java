...
public class PackageListExtractorTest	{
	...
	public void test_one_element_with_header() throws SAXException {
		...
		System.out.println("Testing Description");	
		assertEquals(element.select("cybox|Object >  cybox|description").text(), "stucco1");
		System.out.println("Testing Source");	
		assertEquals(element.select("cybox|Observable_Source > cyboxcommon|information_source_type").text(), "PackageList");
		System.out.println("Testing Title");	
	 ...
	 */
	@Test
	public void test_two_elements_with_no_header() throws SAXException {
		...
		System.out.println("Testing Description");	
		assertEquals(element.select("cybox|Object >  cybox|description").text(), "stucco2");
		System.out.println("Testing Source");	
		assertEquals(element.select("cybox|Observable_Source > cyboxcommon|information_source_type").text(), "PackageList");
		System.out.println("Testing Title");	
		assertEquals(element.select("cybox|title").text(), "Host");
