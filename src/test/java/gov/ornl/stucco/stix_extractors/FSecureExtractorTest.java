...
public class FSecureExtractorTest {
	 ...
	 */
	@Test
	public void test_application_w32_installbrain() throws SAXException {
		System.out.println();
		...
		try {
			...
			assertTrue(fsecurePackage.validate());
	 ...
	 */
	@Test
	public void test_backdoor_w32_havex() throws SAXException {
		System.out.println();
		System.out.println("STIXExtractor.FSecureExtractorTest.test_application_w32_installbrain()");
	 ...
	 */
	@Test
	public void test_trojan_html_browlock() throws SAXException {
		System.out.println();
	 ...
	 */
	@Test
	public void test_trojan_android_droidkungfu_c() throws SAXException {
		System.out.println();
	 ...
	 */
	@Test
	public void test_trojan_bash_qhost_wb() throws SAXException {
		System.out.println();
