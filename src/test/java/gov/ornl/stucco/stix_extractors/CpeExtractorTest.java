 ...
 */
public class CpeExtractorTest extends STIXUtils {
	...
	public void test_one_element()	throws SAXException {
		...
		assertEquals(element.select("cybox|Object").attr("id"), "stucco:software-" + makeId("cpe:/a:1024cms:1024_cms:0.7"));
	 ...
	 */
	@Test
	public void test_one_element_no_description()	throws SAXException {
		...
		assertEquals(element.select("cybox|Title").text(), "Software");
		System.out.println("Testing Description");
		System.out.println(element.select("cybox|Description").text());
		assertEquals(element.select("cybox|Description").text(), "1024cms 1024_cms version 0.7");
		System.out.println("Testing Part");
		assertEquals(element.select("cyboxCommon|Property[name=Part]").text(), "/a");
		System.out.println("Testing Vendor");
		assertEquals(element.select("ProductObj|Vendor").text(), "1024cms");
	 ...
	 */
	@Test
	public void test_three_elements()	throws SAXException {
		...
		Element element = doc.select("cybox|Observable:has(cybox|Object[id=stucco:software-" + makeId("cpe:/a:microsoft:hotmail") + "])").first();

		System.out.println("Testing Id");
		System.out.println(element.select("cybox|Object").attr("id") + " " +  "stucco:software-" + makeId("cpe:/a:microsoft:hotmail"));
		assertEquals(element.select("cybox|Object").attr("id"), "stucco:software-" + makeId("cpe:/a:microsoft:hotmail"));
		System.out.println("Testing Source");
		assertEquals(element.select("cyboxCommon|Information_Source_Type").text(), "CPE");
		System.out.println("Testing Title");
		assertEquals(element.select("cybox|Title").text(), "Software");
		...
		element = doc.select("cybox|Observable:has(cybox|Object[id=stucco:software-" + makeId("cpe:/o:yahama:rtx1100:8.03.82") + "])").first();

		System.out.println("Testing Id");
		assertEquals(element.select("cybox|Object").attr("id"), "stucco:software-" + makeId("cpe:/o:yahama:rtx1100:8.03.82"));
		System.out.println("Testing Source");
		assertEquals(element.select("cyboxCommon|Information_Source_Type").text(), "CPE");
		System.out.println("Testing Title");
		assertEquals(element.select("cybox|Title").text(), "Software");
		...
		element = doc.select("cybox|Observable:has(cybox|Object[id=stucco:software-" + makeId("cpe:/o:yamaha:srt100:10.00.56") + "])").first();

		System.out.println("Testing Id");
		assertEquals(element.select("cybox|Object").attr("id"), "stucco:software-" + makeId("cpe:/o:yamaha:srt100:10.00.56"));
		System.out.println("Testing Source");
		assertEquals(element.select("cyboxCommon|Information_Source_Type").text(), "CPE");
		System.out.println("Testing Title");
		assertEquals(element.select("cybox|Title").text(), "Software");
