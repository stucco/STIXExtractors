...
public class HoneExtractorTest	{
	...
	public void test_one_element_with_header()	{
		...
		System.out.println("going into hone");
		...
		assertTrue(honeExtractor.validate(stixPackage));
...
//hostname -> software relation
		...
		String softwareId = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^host runs software$))").attr("idref");
		...
		Element relation = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^host runs software$))").first();
		assertEquals(relation.select("cybox|Relationship").text(), "host runs software");
...
//hostname -> address relation
		...
		String addressId = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^host uses address$))").attr("idref");
		...
		System.out.println("Testing Relationship");
		relation = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^host uses address$))").first();
		assertEquals(relation.select("cybox|Relationship").text(), "host uses address");
		System.out.println("Testing Relation Description");
...
//software 
		...
		System.out.println("Testing Source");
		assertEquals(softwarePart.select("cybox|Observable > cybox|Observable_Source > cyboxCommon|Information_Source_Type").text(), "Hone");
		System.out.println("Testing Title");
		assertEquals(softwarePart.select("cybox|Title").text(), "Software");
		System.out.println("Testing Description");
...
//software -> flow relation
		...
		String flowId = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^software has flow$))").attr("idref");
		...
		System.out.println("Testing Relationship");
		relation = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^software has flow$))").first();
		assertEquals(relation.select("cybox|Relationship").text(), "software has flow");
		System.out.println("Testing Relation Description");
...
//software -> account
		...
		String accountId = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^software runs as account$))").attr("idref");
		Element account = doc.select("[id=" + accountId + "]").first();
		assertEquals(account.select("cybox|Description").text(), "uid 1000 on host Mary");
		System.out.println("Testing Relationship");
		relation = element.select("cybox|Related_Object:has(cybox|Relationship:matches(^software runs as account$))").first();
		assertEquals(relation.select("cybox|Relationship").text(), "software runs as account");
		System.out.println("Testing Relation Description");
...
//account
		...
		System.out.println("Testing Description");
		assertEquals(element.select("cybox|Object > cybox|Description").text(), "uid 1000 on host Mary");
...
//flow
		...
		assertEquals(element.select("cyboxCommon|Information_Source_Type").text(), "Hone");
		System.out.println("Testing ID");
		assertEquals(element.select("cybox|Object").attr("id"), "stucco:flow-10.32.92.230_49870-69.42.215.170_6667");
